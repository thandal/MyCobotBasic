#ifndef COMMUNICATEDEFINEPRO_H
#define COMMUNICATEDEFINEPRO_H
...
//
#define	GET_GRIPPERVALUE				0x65
#define	GET_GRIPPERVALUE_LEN			2
#define GET_GRIPPERVALUE_RETURN_LEN		3
//
...
#define SET_JOINT_CURRENT			0x90
#define SET_JOINT_CURRENT_LEN		5

#define GET_JOINT_CURRENT			0x91
#define GET_JOINT_CURRENT_LEN		3
#define GET_JOINT_CURRENT_RETURN_LEN	4

#define CHECK_CURRENT_ON			0x92
#define CHECK_CURRENT_ON_LEN		2

#define CHECK_CURRENT_OFF			0x93
#define CHECK_CURRENT_OFF_LEN		2


#endif // !COMMUNICATEDEFINEPRO_H