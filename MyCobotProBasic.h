#ifndef MYCOBOTPROBASIC_H
#define MYCOBOTPROBASIC_H
...
using namespace myCobotProDefine;
using namespace roboticMessages;

class MyCobotProBasic
{
public:
	...
	void setPWMOutput(byte pin_no, byte pin_write);
	...
	void setJointCurrent(Joint joint, float max_current);
	float getJointCurrent(Joint joint);
	void checkCurrentOn();
	void checkCurrentOff();
