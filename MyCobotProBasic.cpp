...
bool MyCobotProBasic::checkHeader()
{
	byte bDat;
	byte bBuf[2] = { 0,0 };
	byte Cnt = 0;
...
int MyCobotProBasic::readSerial(unsigned char* nDat, int nLen)
{
	int Size = 0;
	int rec_data;
...
void MyCobotProBasic::rFlushSerial() {
	while (Serial2.read() != -1)
		;
}


void MyCobotProBasic::powerOn()
{
...
bool MyCobotProBasic::isPoweredOn()
{
	Serial2.write(header);
	Serial2.write(header);
...
void* MyCobotProBasic::readData()
{
	...
	case 4:
		...
		{
		case GET_JOINT_CURRENT:
		{
			Serial.println("get joint current...");
...
Angles MyCobotProBasic::getAngles()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::writeAngle(int joint, float value, int speed)
{
...
void MyCobotProBasic::writeAngles(Angles angles, int speed)
{
...
Coords MyCobotProBasic::getCoords()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::writeCoord(Axis axis, float value, int speed)
{
...
void MyCobotProBasic::writeCoords(Coords coord, int speed)
{
...
int MyCobotProBasic::isInPosition(Coords coord, bool is_linear)
{
	byte coord_x_low = lowByte(static_cast<int>(coord[0] * 10));
	byte coord_x_high = highByte(static_cast<int>(coord[0] * 10));
...
bool MyCobotProBasic::checkRunning()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::jogAngle(int joint, int direction, int speed)
{
...
void MyCobotProBasic::jogCoord(Axis axis, int direction, int speed)
{
...
void MyCobotProBasic::setEncoder(int joint, int encoder)
{
...
int MyCobotProBasic::getEncoder(int joint)
{
	byte joint_number = joint - 1;
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setEncoders(Angles angleEncoders, int speed)
{
...
void MyCobotProBasic::setSpeed(int percentage)
{
...
float MyCobotProBasic::getFeedOverride()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::sendFeedOverride(float feed_override)
{
...
float MyCobotProBasic::getAcceleration()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setAcceleration(float acceleration)
{
...
float MyCobotProBasic::getJointMin(int joint)
{
	byte joint_number = joint - 1;
	Serial2.write(header);
	Serial2.write(header);
	...
	Serial.print("basic getJointMin ");
...
float MyCobotProBasic::getJointMax(int joint)
{
	byte joint_number = joint - 1;
	Serial2.write(header);
	Serial2.write(header);
	...
	Serial.print("basic getJointMax ");
	Serial.println(joint_number);
...
void MyCobotProBasic::setJointMin(int joint, float angle)
{
	byte joint_number = joint - 1;
...
void MyCobotProBasic::setJointMax(int joint, float angle)
{
	byte joint_number = joint - 1;
	byte angle_low = lowByte(static_cast<int>(angle * 10));
	byte angle_high = highByte(static_cast<int>(angle * 10));
...
bool MyCobotProBasic::isServoEnabled(int joint)
{
	byte joint_number = joint - 1;
	Serial2.write(header);
	Serial2.write(header);
...
bool MyCobotProBasic::isAllServoEnabled()
{
	Serial2.write(header);
	Serial2.write(header);
...
byte MyCobotProBasic::getServoData(int joint, byte data_id)
{
	byte joint_number = joint - 1;
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setPinMode(byte pin_no, byte pin_mode)
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setLEDRGB(byte r, byte g, byte b)
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setGripper(int data)
{
...
void MyCobotProBasic::setServoData(byte servo_no, byte servo_state, byte servo_data)
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setFreeMove()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::receiveMessages()
{
	unsigned long t_begin = millis();
	void* tempPtr = nullptr;
...
void MyCobotProBasic::setMovementType(MovementType movement_type)
{
...
MovementType MyCobotProBasic::getMovementType()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setToolReference(Coords coord)
{
	byte coord_x_low = lowByte(static_cast<int>(coord[0] * 10));
	byte coord_x_high = highByte(static_cast<int>(coord[0] * 10));
...
void MyCobotProBasic::setWorldReference(Coords coord)
{
	byte coord_x_low = lowByte(static_cast<int>(coord[0] * 10));
	byte coord_x_high = highByte(static_cast<int>(coord[0] * 10));
...
Coords MyCobotProBasic::getToolReference()
{
	Serial2.write(header);
	Serial2.write(header);
...
Coords MyCobotProBasic::getWorldReference()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setReferenceFrame(RFType rftype)
{
	byte rt = rftype;
...
RFType MyCobotProBasic::getReferenceFrame()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setEndType(EndType end_type)
{
	byte et = end_type;
...
EndType MyCobotProBasic::getEndType()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setDigitalOutput(byte pin_no, byte pin_state)
{
	Serial2.write(header);
	Serial2.write(header);
...
int MyCobotProBasic::getDigitalInput(byte pin_no)
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setPWMMode(byte pin_no, byte channel)
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setPWMOutput(byte pin_no, byte pin_write)
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::releaseServo(byte servo_no)
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::focusServo(byte servo_no)
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setGripperState(byte mode, int sp)
{
	Serial2.write(header);
	Serial2.write(header);
	Serial2.write(SET_GRIPPER_STATE_LEN);
...
void MyCobotProBasic::setGripperValue(int data, int sp)
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::setGripperIni()
{
	Serial2.write(header);
	Serial2.write(header);
...
int MyCobotProBasic::getGripperValue()
{
	Serial2.write(header);
	Serial2.write(header);
	Serial2.write(GET_GRIPPERVALUE_LEN);
	Serial2.write(GET_GRIPPERVALUE);
	Serial2.write(footer);
...
bool MyCobotProBasic::isGripperMoving()
{
	Serial2.write(header);
	Serial2.write(header);
...
void MyCobotProBasic::moveCCoords(Coords begin_coord, Coords middle_coord, Coords end_coord)
{
	// begin_coord
...
void MyCobotProBasic::moveCCoords(Coords middle_coord, Coords end_coord)
{
	// middle_coord
	byte middle_x_low = lowByte(static_cast<int>(middle_coord[0] * 10));
	byte middle_x_high = highByte(static_cast<int>(middle_coord[0] * 10));
...
void MyCobotProBasic::setJointCurrent(Joint joint, float max_current)
{
	byte joint_number = joint;
	byte max_current_low = lowByte(static_cast<int>(max_current * 10));
	byte max_current_high = highByte(static_cast<int>(max_current * 10));
	Serial2.write(header);
	Serial2.write(header);
	Serial2.write(SET_JOINT_CURRENT_LEN);
	Serial2.write(SET_JOINT_CURRENT);
	Serial2.write(joint_number);
	Serial2.write(max_current_high);
	Serial2.write(max_current_low);
	Serial2.write(footer);
}

float MyCobotProBasic::getJointCurrent(Joint joint)
{
	byte joint_number = joint;
	Serial2.write(header);
	Serial2.write(header);
	Serial2.write(GET_JOINT_CURRENT_LEN);
	Serial2.write(GET_JOINT_CURRENT);
	Serial2.write(joint_number);
	Serial2.write(footer);
...
void MyCobotProBasic::checkCurrentOn()
{
	Serial2.write(header);
	Serial2.write(header);
	Serial2.write(CHECK_CURRENT_ON_LEN);
	Serial2.write(CHECK_CURRENT_ON);
	Serial2.write(footer);
}

void MyCobotProBasic::checkCurrentOff()
{
	Serial2.write(header);
	Serial2.write(header);
	Serial2.write(CHECK_CURRENT_OFF_LEN);
	Serial2.write(CHECK_CURRENT_OFF);
	Serial2.write(footer);
}
